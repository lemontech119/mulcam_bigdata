...
<body>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown" rolo="button"
						aria-hashpopup="true" aria-expanded="false">창업 현황<span
							class="caret"></span></a>
	...
	<div class="container">
		<div class="img_center">
			<img alt="member1" src="/mvc/codingBooster/images/FoodTrend.png"
				style="max-width: 100%">
		</div>
	</div>
