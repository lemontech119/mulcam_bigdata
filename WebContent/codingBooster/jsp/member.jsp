...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/mvc/codingBooster/jsp/member.jsp">소개</a></li>
	...
	<div class="container" >
		<div class="img_center" id = image_main></div>
		<br><br>
	</div>
	...
	<script>
			function getContent(menu_num){
			if (window.XMLHttpRequest) {
				var xmlhttp = new XMLHttpRequest();
			} else { 
				var xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
			}
			xmlhttp.open("Get", "/mvc/codingBooster/jsp/member_img.jsp?menu_num="+ menu_num, true);
